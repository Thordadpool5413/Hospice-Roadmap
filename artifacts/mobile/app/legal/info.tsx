...
const s = StyleSheet.create({
  ...
  cardTitle: { flex: 1, fontSize: 14, fontFamily: "Inter_700Bold", color: Colors.text, letterSpacing: -0.2 },
  cardBody: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textMuted, lineHeight: 19 },
  backBtnBottom: {
