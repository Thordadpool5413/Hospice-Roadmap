...
const s = StyleSheet.create({
  ...
  introTitle: { fontSize: 18, fontFamily: "Inter_700Bold", color: Colors.text, letterSpacing: -0.4 },
  introBody: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textMuted, lineHeight: 20 },
  statsBar: {
    flexDirection: "row",
  ...
  statNum: { fontSize: 22, fontFamily: "Inter_700Bold", color: Colors.text, letterSpacing: -0.5 },
  statLabel: { fontSize: 10, fontFamily: "Inter_400Regular", color: Colors.textSubtle, textTransform: "uppercase" },
  statDiv: { width: 1, height: 30, backgroundColor: Colors.divider, marginHorizontal: 8 },
  stickySection: {
    backgroundColor: Colors.background,
    paddingBottom: 8,
    gap: 8,
