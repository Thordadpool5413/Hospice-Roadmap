...
const styles = StyleSheet.create({
  ...
  aboutCard: {
    ...
    backgroundColor: "rgba(18, 30, 90, 0.85)", borderRadius: 14, padding: 14,
    borderWidth: 1, borderColor: "rgba(80, 120, 220, 0.28)",
  },
  aboutText: {
  ...
  scoreSummary: {
    flexDirection: "row", alignItems: "center",
    borderRadius: 17, padding: 17, gap: 16,
    borderWidth: 1.5,
  ...
  scoreOutOf: { fontSize: 18, fontFamily: "Inter_400Regular", color: "#4A6090", marginBottom: 4 },
  scoreRight: { flex: 1, gap: 3 },
  scoreLabel: { fontSize: 17, fontFamily: "Inter_700Bold", letterSpacing: -0.3 },
  scoreDesc: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 18 },

  categoryCard: {
    backgroundColor: "rgba(12, 20, 55, 0.90)", borderRadius: 17,
    borderWidth: 1, borderColor: "rgba(55, 85, 170, 0.22)", overflow: "hidden",
  ...
  categoryHeader: {
    flexDirection: "row", alignItems: "center",
    gap: 11, padding: 15,
    borderBottomWidth: 1, borderBottomColor: "rgba(40, 60, 130, 0.35)",
  },
  categoryIconWrap: {
  ...
  categoryTitle: { flex: 1, fontSize: 15, fontFamily: "Inter_700Bold", color: "#DDE8FF", letterSpacing: -0.25 },
  categoryScore: {
  ...
  option: {
    flexDirection: "row", alignItems: "center",
    padding: 14, borderBottomWidth: 1, borderBottomColor: "rgba(40, 60, 130, 0.30)",
    borderWidth: 0,
  },
  optionLeft: { flexDirection: "row", alignItems: "flex-start", gap: 11, flex: 1 },
  optionRadio: {
  ...
  optionLabel: { fontSize: 14, fontFamily: "Inter_500Medium", color: "#DDE8FF" },
  ...
  saveBtn: {
    ...
    paddingVertical: 15,
    shadowColor: "#4A5E38", shadowOffset: { width: 0, height: 3 },
    shadowOpacity: 0.35, shadowRadius: 8, elevation: 4,
  },
  saveBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
  ragnaBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 9, backgroundColor: Colors.primary, borderRadius: 15,
    paddingVertical: 15,
    shadowColor: Colors.primary, shadowOffset: { width: 0, height: 3 },
    shadowOpacity: 0.40, shadowRadius: 8, elevation: 4,
  },
  ragnaBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
