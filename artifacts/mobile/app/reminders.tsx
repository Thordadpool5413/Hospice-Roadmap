...
export default function RemindersScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* ── Symptom Escalation Alerts toggle (always visible) ── */}
        <View style={styles.group}>
          <Text style={styles.groupTitle}>Symptom Alerts</Text>
          <View style={styles.escalationCard}>
            <View style={[styles.escalationIcon, { backgroundColor: Colors.warningPale }]}>
              <Feather name="activity" size={18} color={Colors.warning} />
            </View>
            <View style={styles.escalationInfo}>
              <Text style={styles.escalationLabel}>Symptom escalation alerts</Text>
              <Text style={styles.escalationSub}>
                Notify when pain, breathlessness, or nausea trends toward a crisis
              </Text>
            </View>
            <Switch
        ...
        {reminders.length === 0 ? (
          <View style={styles.emptyInline}>
            <View style={styles.emptyIcon}>
              <Feather name="bell" size={28} color={Colors.textSubtle} />
            </View>
