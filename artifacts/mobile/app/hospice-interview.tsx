...
const ui = StyleSheet.create({
  field: { gap: 6 },
  fieldLabel: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#EEF4FF", letterSpacing: -0.1 },
  fieldHint: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#5A78A8", lineHeight: 17 },
  textInput: {
    backgroundColor: "rgba(8,16,45,0.95)", borderRadius: 10,
    borderWidth: 1, borderColor: "rgba(50,75,160,0.30)",
    paddingHorizontal: 13, paddingVertical: 11,
    fontSize: 14, fontFamily: "Inter_400Regular", color: "#EEF4FF", minHeight: 44,
  },
  radioGroup: { gap: 8 },
  radioOptions: { gap: 7 },
  radioOption: {
    flexDirection: "row", alignItems: "center", gap: 11, padding: 12, borderRadius: 10,
    borderWidth: 1.5, borderColor: "rgba(55,85,170,0.22)", backgroundColor: "rgba(12,20,55,0.90)",
  },
  radioCircle: {
    width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: "rgba(55,85,170,0.40)",
    alignItems: "center", justifyContent: "center", flexShrink: 0,
  },
  radioDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#fff" },
  radioLabel: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  subSection: { gap: 10, backgroundColor: "rgba(8,16,45,0.95)", borderRadius: 12, padding: 14, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)" },
  subSectionTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#5A78A8", textTransform: "uppercase", letterSpacing: 0.5 },
  subSectionHint: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#3A5080", lineHeight: 17, marginBottom: 4 },
  sectionBody: { gap: 16 },
  divider: { height: 1, backgroundColor: "rgba(55,85,170,0.15)" },
  groupLabel: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#EEF4FF", letterSpacing: -0.2 },
  groupHint: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#5A78A8", lineHeight: 19 },
  infoBox: {
    flexDirection: "row", alignItems: "flex-start", gap: 8,
    backgroundColor: "rgba(60,120,255,0.10)", borderRadius: 10, padding: 12,
    borderWidth: 1, borderColor: "rgba(60,120,255,0.22)",
  },
  infoText: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  warningBox: {
    flexDirection: "row", alignItems: "flex-start", gap: 8,
    backgroundColor: "rgba(200,150,50,0.10)", borderRadius: 10, padding: 12,
    borderWidth: 1, borderColor: Colors.warning + "40",
  },
  warningText: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  scoreCard: { backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", overflow: "hidden" },
  scoreRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 14, paddingVertical: 13, gap: 12 },
  scoreLabel: { flex: 1, fontSize: 13, fontFamily: "Inter_500Medium", color: "#EEF4FF" },
  ...
  scorePipText: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#5A78A8" },
  scoreDivider: { height: 1, backgroundColor: "rgba(55,85,170,0.15)" },
  // Educational box
  educBox: { backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 12, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", overflow: "hidden" },
  educHeader: { flexDirection: "row", alignItems: "center", gap: 8, padding: 12 },
  educTitle: { flex: 1, fontSize: 13, fontFamily: "Inter_700Bold", color: "#A0C0FF" },
  educBody: { paddingHorizontal: 12, paddingBottom: 12, gap: 8 },
  educLine: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 20 },
  termRow: { flexDirection: "row", gap: 6, paddingLeft: 4 },
  termLabel: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#EEF4FF", flexShrink: 0 },
  termDef: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  // Results
  scoreHeader: {
    flexDirection: "row", gap: 16, alignItems: "flex-start",
    backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 16, padding: 16,
    borderWidth: 1, borderColor: "rgba(55,85,170,0.22)",
  },
  scoreBadge: {
    width: 80, height: 80, borderRadius: 16, borderWidth: 3,
    alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,16,45,0.95)", flexShrink: 0,
  },
  ...
  scoreHospiceName: { fontSize: 17, fontFamily: "Inter_700Bold", color: "#EEF4FF", letterSpacing: -0.3, lineHeight: 22 },
  ...
  recReason: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  narrativeCard: {
    backgroundColor: "rgba(60,120,255,0.10)", borderRadius: 14, padding: 16,
    borderWidth: 1, borderColor: "rgba(60,120,255,0.25)", gap: 10,
  },
  narrativeHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  narrativeTitle: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#A0C0FF" },
  narrativeText: { fontSize: 14, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 22 },
  resultsSection: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#5A78A8", textTransform: "uppercase", letterSpacing: 0.5, marginTop: 4 },
  categoryCard: { backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", overflow: "hidden" },
  ...
  categoryName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#EEF4FF", flex: 1 },
  categoryScore: { fontSize: 14, fontFamily: "Inter_700Bold" },
  categoryFinding: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#5A78A8", lineHeight: 19 },
  flagCard: { backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 14, borderWidth: 1, padding: 14, gap: 10 },
  flagRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  flagText: { flex: 1, fontSize: 14, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 20 },
  questionCard: { backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", padding: 14, gap: 12 },
  questionRow: { flexDirection: "row", alignItems: "flex-start", gap: 12 },
  questionNum: {
    width: 24, height: 24, borderRadius: 6, backgroundColor: "rgba(60,120,255,0.12)",
    textAlign: "center", lineHeight: 24, fontSize: 12, fontFamily: "Inter_700Bold", color: Colors.primary, flexShrink: 0,
  },
  questionText: { flex: 1, fontSize: 14, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 20 },
  askRagnaBtn: {
  ...
  landingHero: {
    ...
    borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", alignItems: "center", gap: 10,
  },
  landingIconWrap: {
    width: 60, height: 60, borderRadius: 16,
    backgroundColor: "rgba(60,120,255,0.12)", alignItems: "center", justifyContent: "center",
  },
  landingTitle: { fontSize: 20, fontFamily: "Inter_700Bold", color: "#EEF4FF", letterSpacing: -0.4, textAlign: "center" },
  landingBody: { fontSize: 14, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 22, textAlign: "center" },
  howItWorks: { backgroundColor: "rgba(8,16,45,0.95)", borderRadius: 14, padding: 14, gap: 12, borderWidth: 1, borderColor: "rgba(55,85,170,0.22)" },
  howTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#5A78A8", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 2 },
  howRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  howNum: {
    width: 22, height: 22, borderRadius: 6, backgroundColor: "rgba(60,120,255,0.12)",
  ...
  howText: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", color: "#7A90B8", lineHeight: 19 },
  startBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    backgroundColor: Colors.primary, borderRadius: 14, paddingVertical: 15,
    shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.22, shadowRadius: 10, elevation: 4,
  ...
  savedSectionTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#5A78A8", textTransform: "uppercase", letterSpacing: 0.5 },
  savedCard: {
    flexDirection: "row", alignItems: "center", gap: 14,
    backgroundColor: "rgba(12,20,55,0.90)", borderRadius: 14, padding: 14,
    borderWidth: 1, borderColor: "rgba(55,85,170,0.22)",
  },
  savedScore: {
  ...
  savedCardName: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#EEF4FF", letterSpacing: -0.2 },
  savedCardDate: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#5A78A8" },
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 22, fontFamily: "Inter_700Bold", color: "#EEF4FF", letterSpacing: -0.5 },
  sectionSub: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#5A78A8" },
  bottomNav: {
    flexDirection: "row", alignItems: "center",
  ...
  prevBtn: {
    ...
    backgroundColor: "rgba(14,22,55,0.90)",
    borderWidth: 1, borderColor: "rgba(55,85,170,0.22)", justifyContent: "center",
  },
  prevBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#5A78A8" },
  nextBtn: {
